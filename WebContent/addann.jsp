...
<nav class="navbar navbar-inverse" role="navigation">
    ...
    <form action="annadd.jsp">
    <hr>
    <label><h3>Add an announcement for student.</h3></label><br>
    <input type="text" name="sann">
    <input class="btn btn-info" type="submit"><br>
    <label><h3>Add an announcement for Teacher.</h3></label><br>
    <input type="text" name="tann">
