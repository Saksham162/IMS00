...
String q = "select salary from empreg where username='"+name+"'";
ResultSet rs=st.executeQuery(q);
if(rs.next()) 
{
	out.println("<hr><center><h1>Welcome "+name+"</h1>"); 
	out.println("<hr><h3>your salary :Rs.  "+rs.getString(1)+"</h3></center>");
}
%>
