           ...
           <a class="navbar-brand" href="index.html">SSCBS</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
         		<li><a href="index.html"><button class="btn btn-sm btn-info"><span class="glyphicon glyphicon-user"></span>Log Out</button></a></li>
      			</ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
...
<div class="jumbotron">
    <div class="container text-center">
	     ...
	     <h3><a href="studet.jsp">View your Details</a></h3>
		 <h3><a href="fees.html" >View Fees Details</a></h3>
		 <h3><a href="quiz.jsp" >Take a Quiz</a></h3>
		 <h3><a href="att.jsp" >View Attendance</a></h3>
		 <h3><a href="stuann.jsp" >Recent Announcements</a></h3>
		 </div><!--end container-->
    </div><!--end jumbotron-->
 <hr>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-4">
								<a href="#" class="active" id="loginstu-form-link">Student</a>
							</div>
							<div class="col-xs-4">
								<a href="#" id="loginemp-form-link">Employee</a>
							</div>
							<div class="col-xs-4">
								<a href="#" id="loginadmin-form-link">Admin</a>
							</div>
						</div>
						<hr>
					</div>
...
<%
out.println("<h4 style='color:red'><center>Invalid password! Try again</center><h4>");
} 
} 
else{
%>
