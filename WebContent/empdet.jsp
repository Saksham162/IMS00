...
String q = "select * from empreg where username='"+name+"'";
...
<TR>
   <TH>Password</TH><TD> <%= rs.getString(2) %> </TD>
</TR>
<TR>
   <TH>DOB</TH><TD> <%= rs.getString(3) %> </TD>
</TR>
<TR>
   <TH>Edu. Qualification</TH><TD> <%= rs.getString(4) %> </TD>
</TR>
<TR>
   <TH>E-Mail</TH><TD> <%= rs.getString(5) %> </TD>
</TR>
<TR>   
   <TH>Contact No.</TH><TD> <%= rs.getString(6) %> </TD>
</TR>
<TR>
   <TH>Address</TH><TD> <%= rs.getString(7) %> </TD>
</TR>
<TR>
   <TH>Department</TH><TD> <%= rs.getString(8) %> </TD>
</TR>
<TR>
   <TH>DOA</TH><TD> <%= rs.getString(9) %> </TD>
</TR>
<TR>   
<TH>Salary</TH><TD> <%= rs.getString(10) %> </TD>
</TR>
...
{ 
out.println("Invalid details try again "+name); 
} 
} 
%>
