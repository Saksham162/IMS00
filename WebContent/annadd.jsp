...
<nav class="navbar navbar-inverse" role="navigation">
           ...
           <a class="navbar-brand" href="index.html">SSCBS</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
         		<li><a href="index.html"><button class="btn btn-info"><span class="glyphicon glyphicon-user"></span>Log Out</button></a></li>
      			</ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
    ...
    <% 
       String s = request.getParameter("sann");
       String s1 = request.getParameter("tann");
        if(s!=""){
        	Class.forName("com.mysql.jdbc.Driver"); 
        	java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/userdata","root","admin"); 
        	Statement st= con.createStatement(); 

        	String q = "insert into stuannouncement values('"+s+"')";
        	int a = st.executeUpdate(q);
        	out.println("<h3><center>Announcement for Student added</center></h3>");
        }   
        ...
        if(s1!=""){
        	...
        	String q = "insert into empann values('"+s1+"')";
        	int a = st.executeUpdate(q);
        	out.println("<h3><center>Announcement for Teacher added.</center></h3>");
