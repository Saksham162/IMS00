...
ResultSet rs=st.executeQuery("select * from empreg where username='"+username+"'"); 
if(rs.next()) 
{ 
...
<div class="jumbotron">
    <div class="container text-center">
	     ...
	     <h4><a href="empdet.jsp">View your Details</a></h4>
		 <h4><a href="sal.jsp" >View Salary Details</a></h4>
		 <h4><a href="quiz.jsp" >Take a Quiz</a></h4>
		 <h4><a href="empann.jsp" >View Announcement</a></h4>
		 </div><!--end container-->
    </div><!--end jumbotron-->	
<%
} 
				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-4">
								<a href="#" class="active" id="loginemp-form-link">Employee</a>
							</div>
							<div class="col-xs-4">
